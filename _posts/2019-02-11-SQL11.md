...
Transactions can be a good way to encorporate error handling into your code, an *explicit transaction* starts with `BEGIN TRAN`. `WAITFOR DELAY` can be used to set a physical wait time before an action.   
